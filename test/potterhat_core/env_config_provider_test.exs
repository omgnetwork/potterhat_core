...
defmodule PotterhatCore.EnvConfigProviderTest do
  # Cannot be asynchronous as the tests need to manipulate environment variables
  use ExUnit.Case, async: false
  alias PotterhatCore.EnvConfigProvider
  ...
  setup do
    ...
    potterhat_app_envs = Application.get_env(:potterhat_core, :nodes)
    :ok = Application.put_env(:potterhat_core, :nodes, [])
    ...
    on_exit(fn ->
      ...
      :ok = Application.put_env(:potterhat_core, :nodes, potterhat_app_envs)
    end)
